                ...
                <div className="glass p-10 rounded-3xl space-y-8 relative overflow-hidden">
                    ...
                    <div className="text-center relative">
                        ...
                        <p className="text-slate-400 mt-2 text-sm font-medium">
                            {step === 1 ? 'Log in to match your skills with job roles' : 'Enter the 6-digit OTP sent to your email'}
                        </p>
                    </div>
                    ...
                    {step === 1 ? (
                        ...
                        <form onSubmit={handleVerify} className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-300 ml-1 uppercase tracking-wider">One-Time Password</label>
                                <div className="relative">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 z-10" size={18} />
                                    <input 
